...
import 'package:auto/servicios/facade/ListaAutoFacade.dart';
import 'package:auto/servicios/facade/modelo/AutosWS.dart';
import 'package:auto/servicios/facade/modelo/ListaAutoWS.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ListTile(
              ...
              title: Text(auto.nombre_marca + ' ' + auto.modelo),
              subtitle: Text('Precio: ' +
                  auto.precio.toString() +
                  ' Año: ' +
                  auto.anioFabricacion.toString()),
            ),
            Row(
